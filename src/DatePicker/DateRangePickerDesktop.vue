<template>
  <v-card class="date-range-picker-desktop elevation-4 mx-auto pt-4">
          ...
          <v-row :class="['picker-main', pickerMainIsActive ? 'active' : '']">
            ...
            <v-col cols="6" class="ml-n3">
              <v-date-picker
                ...
                class="picker-main-right pa-0"
              />
            </v-col>
          </v-row>
          <v-row class="picker-compare" v-if="compare">
            <v-col cols="6" class="">
              <v-date-picker
...
.date-range-picker-desktop::v-deep {
  max-width: 1040px;
  margin-top: 8vh;
