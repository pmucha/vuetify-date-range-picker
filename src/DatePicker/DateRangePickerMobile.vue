<template>
  <v-card
    class="date-range-picker-mobile ma-2 pa-0 elevation-4 d-flex flex-column"
  >
    <v-card-text class="d-flex py-8">
      <v-row>
        <v-col cols="12">
          <v-row>
            <v-col cols="12">
...
.date-range-picker-mobile::v-deep {
  .picker-input {
